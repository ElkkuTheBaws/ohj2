 ...
 *
 */
public class LandlordTietueDialogController<TYPE extends Tietue> implements ModalControllerInterface<TYPE>,Initializable  {
...
// ========================================================    
    ...
    public static<TYPE extends Tietue> TYPE kysyTietue(Stage modalityStage, TYPE oletus, int kentta) {
        return ModalController.<TYPE, LandlordTietueDialogController<TYPE>>showModal(
                LandlordTietueDialogController.class.getResource("LandlordDialogTietueView.fxml"),
                "Kerho",
